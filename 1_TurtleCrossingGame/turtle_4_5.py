# *** Die Schildkröte wird nach Erreichen der andern Seite nicht auf die Ausgangsposition versetzt!?

# ----> Es wurde wieder genau das gleiche Skript vorgeschlagen!!!??

# Es tut mir leid für die Verwirrung. Hier ist die korrigierte Version des Skripts, in der die Schildkröte nach dem
# Erreichen der anderen Seite in die Ausgangsposition zurückgesetzt wird:
